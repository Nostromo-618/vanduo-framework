...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/vanduo-oss/framework@v1.2.4/dist/vanduo.min.css">
<script src="https://cdn.jsdelivr.net/gh/vanduo-oss/framework@v1.2.4/dist/vanduo.min.js"></script>
<script>Vanduo.init();</script>
```
...
```bash
pnpm run release:assets -- v1.2.4
```
